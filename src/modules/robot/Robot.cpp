...
{
    register_for_event(ON_GCODE_RECEIVED,  Robot::on_gcode_received);
    register_for_event(ON_GET_PUBLIC_DATA, Robot::on_get_public_data);
    register_for_event(ON_SET_PUBLIC_DATA, Robot::on_set_public_data);
