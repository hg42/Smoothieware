...
void Endstops::on_module_loaded()
{
    ...
    register_for_event(ON_GCODE_RECEIVED,  Endstops::on_gcode_received);
    register_for_event(ON_GET_PUBLIC_DATA, Endstops::on_get_public_data);
    register_for_event(ON_SET_PUBLIC_DATA, Endstops::on_set_public_data);
