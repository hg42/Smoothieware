...
void PlayLed::on_module_loaded()
{
    ...
    //register_for_event(ON_PLAY,        PlayLed::on_play);
    ...
    //register_for_event(ON_BLOCK_BEGIN, PlayLed::on_block_begin);
    //register_for_event(ON_BLOCK_END,   PlayLed::on_block_end);
