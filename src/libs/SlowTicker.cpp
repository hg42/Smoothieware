...
void SlowTicker::on_module_loaded(){
    register_for_event(ON_IDLE,           SlowTicker::on_idle);
    register_for_event(ON_GCODE_RECEIVED, SlowTicker::on_gcode_received);
    register_for_event(ON_GCODE_EXECUTE,  SlowTicker::on_gcode_execute);
}
